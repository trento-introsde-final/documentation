...
ALTER TABLE GOAL ADD FOREIGN KEY(person_id) REFERENCES PERSON(id) ON DELETE CASCADE;
ALTER TABLE GOAL ADD FOREIGN KEY(goal_measure_type) REFERENCES GOAL_MEASURE_TYPE(id)  ON DELETE CASCADE;
ALTER TABLE GOAL ADD FOREIGN KEY(goal_period) REFERENCES GOAL_PERIOD(days_length)  ON DELETE CASCADE;
ALTER TABLE RUN_HISTORY ADD FOREIGN KEY(person_id) REFERENCES PERSON(id)  ON DELETE CASCADE;
